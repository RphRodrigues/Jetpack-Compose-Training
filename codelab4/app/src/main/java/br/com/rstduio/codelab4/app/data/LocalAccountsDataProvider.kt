...
package br.com.rstduio.codelab4.app.data

import br.com.rstduio.codelab4.app.R
import br.com.rstduio.codelab4.app.data.Account


/**
 * An static data store of [br.com.rstduio.codelab4.app.data.Account]s. This includes both [br.com.rstduio.codelab4.app.data.Account]s owned by the current user and
 * all [br.com.rstduio.codelab4.app.data.Account]s of the current user's contacts.
 */
